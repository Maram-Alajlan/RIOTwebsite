			...
			<div class="container">
				...
				<div id="main-nav-collapse" class="collapse navbar-collapse">
					<ul class="nav navbar-nav main-navbar-nav">
						...
						<li class="dropdown "><a href="publication.php"
						...
						<li class="dropdown "><a href="news.php"
							class="dropdown-toggle" data-toggle="dropdown">NEWS </a></li>

						<li class="dropdown "><a href="joinus.php"
							class="dropdown-toggle" data-toggle="dropdown">JOIN US</a></li>
